...
class StreamAudioProvider(
    ...
    override val format: AudioFormat = input?.format
        ?: throw IllegalArgumentException("AudioInputStream cannot be null")
    ...
    override fun next(samples: Int) = advance(samples) { array, end ->
        ...
        if( bytes == null || bytes.isEmpty()) throw IllegalArgumentException("AudioInputStream cannot be null")
